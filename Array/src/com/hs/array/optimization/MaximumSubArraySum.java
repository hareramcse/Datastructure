...
public class MaximumSubArraySum {
	...
	static int maxSubArraySum3(int a[], int size) {
		int max_so_far = a[0];
		int curr_max = a[0];
	...
	public static void main(String[] args) {
		...
		System.out.println("Maximum contiguous sum is " + maxSubArraySum2(a, a.length));
		System.out.println("Maximum contiguous sum is " + maxSubArraySum3(a, a.length));
	}
}
