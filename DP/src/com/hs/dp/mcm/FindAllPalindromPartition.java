...
public class FindAllPalindromPartition {
	...
	public static void main(String[] args) {
		FindAllPalindromPartition mcm = new FindAllPalindromPartition();
		String str = "aab";
		List<List<String>> allString = mcm.partition(str);
		System.out.println("All String is " + allString);
	}
}
