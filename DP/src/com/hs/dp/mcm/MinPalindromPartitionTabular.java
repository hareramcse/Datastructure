...
// 132. Palindrome Partitioning II Leetcode(TLE)
public class MinPalindromPartitionTabular {
	...
	public static void main(String[] args) {
		MinPalindromPartitionTabular mcm = new MinPalindromPartitionTabular();
		String str = "aab";
		int count = mcm.minCut(str);
		System.out.println("Min cut is " + count);
	}
}