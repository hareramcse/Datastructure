...
public class FleuryAlgoForEularianPath {

	private int vertices; // No. of vertices
	private ArrayList<Integer>[] adj; // adjacency list

	// Constructor
	FleuryAlgoForEularianPath(int numOfVertices)
	{
	...
	public static void main(String a[]) {
		...
		FleuryAlgoForEularianPath g1 = new FleuryAlgoForEularianPath(4);
		g1.addEdge(0, 1);
		g1.addEdge(0, 2);
		g1.addEdge(1, 2);
		g1.addEdge(2, 3);
		...
		FleuryAlgoForEularianPath g2 = new FleuryAlgoForEularianPath(3);
		g2.addEdge(0, 1);
		g2.addEdge(1, 2);
		g2.addEdge(2, 0);
		g2.printEulerTour();

		FleuryAlgoForEularianPath g3 = new FleuryAlgoForEularianPath(5);
		g3.addEdge(1, 0);
		g3.addEdge(0, 2);
		g3.addEdge(2, 1);
		g3.addEdge(0, 3);
