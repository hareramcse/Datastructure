...
class ConvertBinaryTreeThatHoldsChildrenSumProperty {
	/*
	...
	public static void main(String args[]) {
		ConvertBinaryTreeThatHoldsChildrenSumProperty tree = new ConvertBinaryTreeThatHoldsChildrenSumProperty();
