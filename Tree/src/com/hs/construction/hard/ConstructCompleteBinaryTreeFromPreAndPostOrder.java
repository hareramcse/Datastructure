 ...
 * post[] = {8, 9, 4, 5, 2, 6, 7, 3, 1}; In pre[], the leftmost element is root of tree. 
 * Since the tree is full and array size is more than 1. The value next to 1 in pre[],
 * must be left child of root. So we know 1 is root and 2 is left child. How to find 
 * the all nodes in left subtree? We know 2 is root of all nodes in left subtree. All 
 * nodes before 2 in post[] must be in left subtree. Now we know 1 is root, elements 
